...
class GUI(Tk):
  ...
  def __init__(self):
    ...
    self.lb_folder = Label(self.frame1, text="Folder")
    self.lb_folder.grid(column=0, row=0)
    self.lb_extension = Label(self.frame1, text="Extension")
    self.lb_extension.grid(column=0, row=1)
    ...
    self.lb_tracknumber = Label(self.frame3, text="Track Number")
    self.lb_tracknumber.grid(column=0, row=0)
    self.et_tracknumber = Entry(self.frame3)
    self.et_tracknumber.grid(column=1, row=0)
    self.lb_filename = Label(self.frame3, text="Filename")
    self.lb_filename.grid(column=0, row=1)
